...
public class EjecutarGenericoSalesAService implements IEjecutar{
	...
	public void procesar(AbstractJsonRestEstructura resultadoMapeo, JSONObject jsonActual){
		...
		if(urlVerificarExistencia!=null){
			GetExistFieldURLQueryRightNow getContactosEnSales = new GetExistFieldURLQueryRightNow(urlVerificarExistencia, r.getCabeceraInsertar());//Puede haber más de un contacto con el mismo DNI pero distinto contact_type
