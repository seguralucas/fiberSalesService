...
public class ConstantesGenerales {
	 ...
	 public static String PATH_HUSO_HORARIO=PATH_EJECUCION+"/Configuracion/Timer/HusoHorario.txt";
	 ...
	 static{
		 try {
			...
			PATH_HUSO_HORARIO=PATH_EJECUCION+"/Configuracion/Timer/HusoHorario.txt";		
